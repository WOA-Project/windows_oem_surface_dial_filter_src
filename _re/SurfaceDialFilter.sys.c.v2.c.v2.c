...
void **__fastcall sub_140002FE0(__int64 a1)
{
  ...
  v9 = WdfIoTargetWdmGetTargetFileObject() == v5;
...
__int64 __fastcall DoScreenSave(PVOID StartContext)
{
  __int64 v2;
  NTSTATUS v3;
  unsigned int v4;
  ...
  if (off_14000D008 != &off_14000D008 && LOWORD(DeviceObject->DeviceType))
    sub_1400016A8(DeviceObject->DeviceExtension, 5, 3, 55, (__int64)&unk_14000B2C0);
  v2 = WdfObjectGetTypedContextWorker(
      StartContext,
      off_14000D028);
  sub_14000A4C0((__m128 *)v2, 0, 0x288ui64);
  sub_14000A4C0(v21, 0, 0x54ui64);
  v18 = 96;
  v20 = 2;
  v19 = 3;
  v3 = WdfIoQueueCreate(
  ...
  if (v3 >= 0)
  {
    ...
    if (v3 >= 0)
    {
      ...
      v13 = 0x100000001i64;
      ThreadHandle_8 = 0i64;
      LODWORD(ThreadHandle_8) = 56;
      v15 = 0i64;
      v14 = StartContext;
      v3 = WdfSpinLockCreate(
          &ThreadHandle_8,
          v2 + 168);
      v4 = v3;
      if (v3 >= 0)
      {
        ...
        if (v3 >= 0)
        {
          ...
          if (v3 >= 0)
          {
            ...
            *(_DWORD *)(v2 + 616) = -1;
            *(_DWORD *)(v2 + 638) = -1;
            *(_DWORD *)(v2 + 620) = 0x7FFFFFFF;
            KeInitializeEvent((PRKEVENT)(v2 + 176), NotificationEvent, 0);
            KeInitializeEvent((PRKEVENT)(v2 + 200), NotificationEvent, 0);
            KeInitializeEvent((PRKEVENT)(v2 + 224), NotificationEvent, 0);
            KeInitializeEvent((PRKEVENT)(v2 + 248), NotificationEvent, 0);
            KeInitializeEvent((PRKEVENT)(v2 + 408), NotificationEvent, 0);
            KeInitializeEvent((PRKEVENT)(v2 + 568), NotificationEvent, 0);
            *(_DWORD *)(v2 + 624) = 5;
            *(_BYTE *)(v2 + 628) = 0;
            *(_DWORD *)(v2 + 632) = 500;
            *(_QWORD *)&ObjectAttributes.Length = 48i64;
            *(_QWORD *)&ObjectAttributes.Attributes = 512i64;
            ThreadHandle = 0i64;
  ...
  sub_14000176C((__int64)DeviceObject->DeviceExtension, 2u, 3u, v5, (__int64)&unk_14000B2C0, StartRoutine);
LABEL_44:
  if (off_14000D008 != &off_14000D008 && LOWORD(DeviceObject->DeviceType))
  {
    LODWORD(StartRoutine) = v4;
    sub_14000176C((__int64)DeviceObject->DeviceExtension, 5u, 3u, 0x48u, (__int64)&unk_14000B2C0, StartRoutine);
  }
  return v4;
}